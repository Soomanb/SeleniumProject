...
public class RTTC082Test
{
	...
	private String expectedResult = "Success: You have modified returns!\n" + 
			"×";
			
	// fetch the data from the specified excel sheet
  @Test(dataProvider = "excel-Customer-Return-inputs-positive", dataProviderClass = LoginDataProviders.class)
  
	public void CustomerReturnsByAdminPositv(String Orderid, String Customer, String fname, String lname, String Email, String Telphn, String Product, String Model) {
	  ...
	  actualResult=returnsPOM.GetConfirmationMsg();  // Get the Confirmation message after successfully deleting customer
